...
export function SceneDetailPage() {
  ...
  return <main>
    ...
    <section className="content-wrap grid gap-8 py-12 lg:grid-cols-[1fr_320px]"><div><p className="eyebrow">Upcoming activity</p><h2 className="font-display mt-3 text-4xl uppercase">Dates carried by this scene</h2><div className="panel mt-6 p-8 text-foreground-secondary">No public dates are attached to this read model yet.</div></div><aside><button className="button-primary w-full">Request membership</button><Link to={`/search?scene=${scene.id}`} className="button-secondary mt-3 w-full">Search related activity</Link></aside></section>
  </main>;
}
