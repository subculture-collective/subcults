...
export function ScenesPage() {
  ...
  return <main><PageMeta title="Local music scenes"/>
    ...
    <section className="content-wrap py-12"><div className="flex items-end justify-between gap-5"><div><p className="eyebrow">Public scenes</p><h2 className="font-display mt-2 text-4xl uppercase">Browse communities</h2></div><Link className="button-secondary" to="/creator-access">Publish a scene</Link></div>
