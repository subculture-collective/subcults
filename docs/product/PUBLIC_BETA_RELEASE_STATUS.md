...
| Durable core repositories | PostgreSQL adapters for Scene/Event/RSVP, Touring, Audience, and Signal; existing identity/location/push adapters | Tagged integration tests and a live API restart preserve records; stale writes conflict |
| Database evolution | Additive migrations 0 through 40 | Fresh and 39-to-40 PostGIS migrations reach version 40; version 39 startup fails closed |
...
allowlist and operating procedure are documented in
`docs/operations/DURABLE_BETA_POSTGRES.md`.
