...
The API requires schema version 45 and exits before binding its port when the
...
4. run the tagged database integration tests against version 45.
...
the restored schema reports version 45. Managed production also needs its
